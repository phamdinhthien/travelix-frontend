                    ...
                    <div className="row intro_items">
                        ...
                        <div className="col-lg-4 intro_col">
                            <div className="intro_item">
                                ...
                                <div className="intro_item_background" style={{ backgroundImage: 'url(' + require('../../../images/intro_1.jpg') + ')' }} />
                                <div className="intro_item_content d-flex flex-column align-items-center justify-content-center">
                                    ...
                                    <div className="button intro_button">
                                        <div className="button_bcg" /><a href="#">see
                        ...
                        <div className="col-lg-4 intro_col">
                            <div className="intro_item">
                                ...
                                <div className="intro_item_background" style={{ backgroundImage: 'url(' + require('../../../images/intro_2.jpg') + ')' }} />
                                <div className="intro_item_content d-flex flex-column align-items-center justify-content-center">
                                    <div className="intro_date">May 25th - June 01st</div>
                                    <div className="button intro_button">
                                        <div className="button_bcg" /><a href="#">see
                        ...
                        <div className="col-lg-4 intro_col">
                            <div className="intro_item">
                                ...
                                <div className="intro_item_background" style={{ backgroundImage: 'url(' + require('../../../images/intro_3.jpg') + ')' }} />
                                <div className="intro_item_content d-flex flex-column align-items-center justify-content-center">
                                    <div className="intro_date">May 25th - June 01st</div>
                                    <div className="button intro_button">
                                        <div className="button_bcg" /><a href="#">see
