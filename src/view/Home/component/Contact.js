    ...
    render() {
        return (
            <div className="contact">
                <div className="contact_background" style={{ backgroundImage: 'url(' + require('../../../images/contact.png') + ')' }} />
                        ...
                        <div className="col-lg-7">
                            <div className="contact_form_container">
                                ...
                                <form action="#" id="contact_form" className="contact_form">
                                    ...
                                    <button type="submit" id="form_submit_button" className="form_submit_button button">send
                        message<span /><span /><span /></button>
                                </form>
                            </div>
                        </div>
                    </div>
