    ...
    render() {
        return (
            <div className="cta">
              ...
              <div className="cta_background" style={{backgroundImage: 'url('+ require('../../../images/cta.jpg') + ')'}} />
              <div className="container">
                <div className="row">
                  <div className="col">
                    {/* CTA Slider */}
                    <div className="cta_slider_container">
                      <OwlCarousel ref="cta" options={options} events={events} className="owl-carousel owl-theme cta_slider">
                        {/* CTA Slider Item */}
                        <div className="owl-item cta_item text-center">
                          ...
                          <p className="cta_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam
                          ...
                          <div className="button cta_button">
                            <div className="button_bcg" /><a href="#">book
                      ...
                      {/* CTA Slider Nav - Prev */}
                      <div className="cta_slider_nav cta_slider_prev" onClick={() => this.refs.cta.prev()}>
                      ...
                      {/* CTA Slider Nav - Next */}
                      <div className="cta_slider_nav cta_slider_next" onClick={() => this.refs.cta.next()}>
