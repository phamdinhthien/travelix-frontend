...
const options = {
  ...
  const events = {
    onChanged: function(event) {
      ...
      let index = event.page.index + 2;
      $('.home_slider_content_inner').removeClass('flipInX');
      $('.home_slider_content_inner').eq(index).addClass('flipInX');
    }
  };
            ...
            <div className="home">
              ...
              <div className="home_slider_container">
                <div className="home_slider">
                  {/* Slider Item */}
                  <OwlCarousel ref="home" options={options} events={events}>
                  <div className="owl-item home_slider_item">
                    <div className="home_slider_background" style={{backgroundImage: 'url('+ require('../../../images/home_slider.jpg') + ')'}}></div>
                        <div className="home_slider_content text-center">
                                <div className="home_slider_content_inner animated">
                                    <h1>discover</h1>
                                    <h1>the world</h1>
                                    <div className="button home_slider_button">
                                        <div className="button_bcg"></div><a href="#">explore now<span></span><span></span><span></span></a>
                                    </div>
                                </div>
                        </div>
                  </div>
                ...
                <div className="home_slider_nav home_slider_prev" onClick={() => this.refs.home.prev()} >
                ...
                <div className="home_slider_nav home_slider_next" onClick={() => this.refs.home.next()} >
                ...
                {/* Home Slider Dots */}
                  <div className="home_slider_dots">
                    <ul id="home_slider_custom_dots" className="home_slider_custom_dots" onClick={this.onActive}>
                      <li className="home_slider_custom_dot active" onClick={() => this.refs.home.goTo(0)}>
                        <div></div>01.
                      </li>
                      <li className="home_slider_custom_dot" onClick={() => this.refs.home.goTo(1)}>
                        <div></div>02.
                      </li>
                      <li className="home_slider_custom_dot" onClick={() => this.refs.home.goTo(2)}>
                        <div></div>03.
                      </li>
                    </ul>
                  </div>
